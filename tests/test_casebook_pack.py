"""Regression checks for the thread-mob-storage-vault casebook."""
...
from casebook.harness import assert_expected, thread_mob_storage_vault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(thread_mob_storage_vault_summary(), assert_expected())
